...
describe('repoToPackId', () => {
  ...
  it('parses full https github URLs', () => {
    expect(repoToPackId('https://github.com/Comfy-Org/ComfyUI-Manager')).toBe('comfyui-manager')
    expect(repoToPackId('https://github.com/Comfy-Org/ComfyUI-Manager.git')).toBe('comfyui-manager')
  })
