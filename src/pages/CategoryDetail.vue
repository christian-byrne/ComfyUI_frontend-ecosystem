  ...
  <section class="p-6 max-w-5xl mx-auto" data-test="category-detail">
    ...
    <template v-if="category">
      <header class="mt-3 mb-6">
        <div class="text-xs font-mono text-zinc-500">{{ category.category_id }}</div>
      ...
      <section class="mb-8" data-test="member-patterns">
        ...
        <ul class="flex flex-wrap gap-2">
          <li
            v-for="pid in category.member_pattern_ids"
            :key="pid"
          >
            <RouterLink
      ...
      <section data-test="stub-trio">
        ...
        <div class="space-y-4">
          ...
          >
            <header class="flex items-center justify-between px-3 py-2 border-b border-zinc-800 text-xs">
              <div class="flex items-center gap-3">
                <span class="font-mono text-zinc-300">bc-{{ category.category_id.replace('BC.', '') }}.{{ variant }}.test.ts</span>
                <span
                  ...
                  :class="{
                    ...
                    'bg-zinc-800 text-zinc-400': stateLabel(variant) === 'absent' || stateLabel(variant) === 'idle',
