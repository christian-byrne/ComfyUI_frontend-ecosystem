  ...
  >
    ...
    >
      ...
      >
        <div>
          <p
            class="text-xs uppercase tracking-wider text-zinc-500 dark:text-zinc-400"
          >
            Evidence
          </p>
          <h2
      ...
      <ol class="divide-y divide-zinc-100 text-sm">
        ...
        >
          ...
          <span
            v-else
            class="font-mono text-xs text-zinc-700 dark:text-zinc-300 break-all"
          >
            {{ row.file
            }}<span
              v-if="row.lines?.length"
          ...
          <div
            v-if="row.variant || row.breakage_class"
        ...
        <li
          ...
          class="px-5 py-6 text-zinc-500 dark:text-zinc-400 italic"
        >
