...
describe('evidenceDrawer.vue', () => {
  it('does not render when closed', () => {
    ...
    expect(wrapper.find('[data-testid="evidence-drawer-root"]').exists()).toBe(false)
  })
  ...
  it('renders when open', () => {
    ...
    expect(wrapper.find('[data-testid="evidence-drawer-root"]').exists()).toBe(true)
  })
  ...
  it('emits close on Escape key', async () => {
    ...
    await wrapper.find('[data-testid="evidence-drawer-root"]').trigger('keydown', { key: 'Escape' })
    expect(wrapper.emitted('close')).toBeTruthy()
  })
